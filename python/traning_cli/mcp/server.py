...
mcp.tool()(tools.get_run_character)
...
mcp.tool()(tools.get_alcohol)
mcp.tool()(tools.get_health_metric)
mcp.tool()(tools.compare_periods)
mcp.tool()(tools.get_sport_mix)
mcp.tool()(tools.get_sport_ctl_overlay)
mcp.tool()(tools.get_sport_calendar)
